...
/**
 * Color picker based on http://about-android.blogspot.com/2010/04/create-cutomized-color-picker-in.html
...
class ColorPickerDialog extends Dialog {
    ...
    private static class ColorPickerView extends View {
        ...
        ColorPickerView(Context c, OnColorChangedListener l, int color, int index) {
            super(c);
            mListener = l;
            mCurColor = color;
            mIndex = index;
        ...
        public boolean onTouchEvent(MotionEvent event) {
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    if (mTrackingCenter) {
                        if (inCenter) {
                            mListener.colorChanged(mCenterPaint.getColor(), mIndex);
                        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(new ColorPickerView(getContext(), l, mInitialColor, mIndex));
